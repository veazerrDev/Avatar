...
Сайт присвячений всесвіту фільму :contentReference[oaicite:0]{index=0}.  
...
## Основна ідея
Сайт створений як фанатський/промо-проєкт у стилі Avatar, щоб передати атмосферу світу Пандори та познайомити користувачів із культурою На’ві. :contentReference[oaicite:1]{index=1}
